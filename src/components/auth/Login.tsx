...
import { BRAND_LOGIN_LINE, BRAND_OWNER, BRAND_TAGLINE } from '../../branding';
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">{BRAND_LOGIN_LINE}</p>
        ...
        <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl">
          ...
          <div className="mt-8 pt-8 border-t border-slate-800 text-center">
            <p className="text-slate-400">
              ...
              <button onClick={onGoToRegister} className="text-emerald-500 font-medium hover:underline">
                Create Account
              </button>
            </p>
          </div>
